          ...
          <li key={step.name} className={classNames(stepIdx !== steps.length - 1 ? 'pr-8 sm:pr-8' : '', 'relative')}>
            {step.status === 'complete' ? (
              <>
                ...
                <a
                  href="#"
                  className="relative w-4 h-4 flex items-center justify-center bg-yellow-400 rounded-full hover:bg-yellow-900"
                >
              ...
              <>
                ...
                <a
                  href="#"
                  className="relative w-4 h-4 flex items-center justify-center bg-white border-2 border-yellow-400 rounded-full"
                  aria-current="step"
                >
                  <span className="h-2.5 w-2.5 bg-yellow-400 rounded-full" aria-hidden="true" />
                  <span className="sr-only">{step.name}</span>
                </a>
              </>
            ) : (
