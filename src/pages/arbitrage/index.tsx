                      ...
                      <table className="min-w-full divide-y divide-yellow-900">
                        ...
                        <tbody className="bg-white dark:bg-gray-800 divide-y dark:divide-gray-900">
                          {arbitrages.map((arbitrage) => (
                            <tr key={arbitrage.id}>
                              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-400">{arbitrage.exchange}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-400">{arbitrage.transaction}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-400">{arbitrage.profit}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-400">{arbitrage.aport}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
