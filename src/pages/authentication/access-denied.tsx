    ...
    <>
      <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          />
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">você não tem permissão</h2>
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary-500 sm:text-sm"
                  />
                </div>
              </div>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">ou logue com sua conta</span>
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                <div>
                  ...
                  >
                    <span className="sr-only">logar com facebook</span>
                ...
                <div>
                  <a
                    ...
                    className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
                  >
                    <span className="sr-only">logar com twitter</span>
                    <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
