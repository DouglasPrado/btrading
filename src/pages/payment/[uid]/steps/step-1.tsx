...
import FormUser from '@/components/Pages/Payments/FormUser';

const steps = [
  { id: '01', name: 'Dados pessoais', href: '/payment/2/steps/step-1', status: 'current' },
  { id: '02', name: 'Pagamento', href: '/payment/2/steps/step-2', status: 'upcoming' },
  { id: '03', name: 'Confirmação', href: '/payment/2/steps/step-3', status: 'upcoming' },
]

export default function StepsOne({ dataUser, product }) {
...
export async function getServerSideProps(context) {
  ...
  const dataUser = {
    ...
    document_number: '39870264808',
    address: {
      street: 'Rua Idano de Oliveira',
      street_number: '123',
